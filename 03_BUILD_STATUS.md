...
- Deployed app: https://0xskrillah.github.io/ghostname/ (gh-pages branch,
  ...
  Current deployment: gh-pages commit `a897a02`, built from source commit
  `cc0f15af1946` (`main` after PR #8: the recording guide, the slide copy,
  guard support for new demo identities and the five-parameter handoff card,
  on top of the disconnect button, the AI-agent layer, the release audit and
  the UI/UX fixes) with
