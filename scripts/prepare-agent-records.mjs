...
function assertNotProtectedName(name) {
  if (name === 'skrillah.eth' || name.endsWith('.skrillah.eth')) {
    throw new Error('skrillah.eth is read-only demo input and is never modified by any script.');
  }
}
